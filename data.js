...
const DAY_DETAILS = {
  1: { grammar: "to be — forme affirmative (I am, you are, he/she/it is...)", vocab: "Pronoms sujets : I, you, he, she, it, we, they", vocabWords: ["I", "you", "he", "she", "it", "we", "they"], vocabExamples: [["I am happy.", "Je suis heureux/heureuse."], ["You are kind.", "Tu es gentil(le)."], ["He is here.", "Il est ici."], ["We are ready.", "Nous sommes prêts."]], didYouNotice: "« to be » ne change presque jamais — seulement am / are / is. En français, être change beaucoup plus. Ce sera une des rares fois où l'anglais est plus simple que le français !", mistake: { wrong: "I have 30 years.", right: "I am 30 years old.", note: "En anglais, on EST un âge (to be), on ne l'a pas (to have), contrairement au français « avoir X ans »." }, tables: [CONJUGATIONS.toBePresent], prompt: "Parle de toi et de ta famille avec « to be » — utilise au moins trois formes différentes (I am, you are, he/she is...).", promptEn: "Talk about yourself and your family using « to be » — use at least three different forms (I am, you are, he/she is...)." },
  2: { grammar: "to be — négation et questions (I am not, Are you...?, Is he...?)", vocab: "Négation et inversion", vocabWords: ["not", "Are you...?", "Is he/she...?"], vocabExamples: [["I am not tired.", "Je ne suis pas fatigué(e)."], ["Are you ready?", "Es-tu prêt(e) ?"], ["Is she French?", "Est-elle française ?"], ["We are not late.", "Nous ne sommes pas en retard."]], didYouNotice: "Pour poser une question avec « to be », on inverse simplement le sujet et le verbe : « You are » devient « Are you? ». Pas besoin d'un mot supplémentaire, contrairement au « est-ce que » français.", tables: [CONJUGATIONS.toBePresent], prompt: "Pose trois questions avec « to be » à quelqu'un, et réponds à la forme négative si la réponse est non.", promptEn: "Ask someone three questions with « to be », and answer in the negative form if the answer is no." },
  3: { grammar: "to have — présent simple (I have, you have, he/she has...)", vocab: "Possession : famille, objets", vocabWords: ["a brother", "a sister", "a car", "a house"], vocabExamples: [["I have a sister.", "J'ai une sœur."], ["He has a car.", "Il a une voiture."], ["We have a big family.", "Nous avons une grande famille."], ["They have two children.", "Ils ont deux enfants."]], mistake: { wrong: "She has 25 years.", right: "She is 25 years old.", note: "Même piège qu'au Jour 1 : l'âge se dit avec « to be », jamais avec « to have »." }, tables: [CONJUGATIONS.toHavePresent], prompt: "Dis trois choses que tu as et trois choses que ta famille a, avec « to have ».", promptEn: "Say three things you have and three things your family has, using « to have »." },
  4: { grammar: "to have got — forme alternative de have, très fréquente à l'oral", vocab: "Révision : possession", vocabWords: ["I've got", "he's got", "we've got"], vocabExamples: [["I've got a new phone.", "J'ai un nouveau téléphone."], ["He's got two sisters.", "Il a deux sœurs."], ["Have you got a car?", "As-tu une voiture ?"]], didYouNotice: "« have got » et « have » veulent dire exactement la même chose. Tu entendras les deux constamment — reconnais-les, mais commence par utiliser la forme simple « I have », plus facile à construire.", tables: [CONJUGATIONS.toHaveGot], prompt: "Reprends trois phrases du Jour 3 et redis-les avec « have got » à la place de « have ».", promptEn: "Take three sentences from Day 3 and say them again using « have got » instead of « have »." },
  5: { grammar: "can — capacité et permission (I can, I can't, Can you...?)", vocab: "Capacités", vocabWords: ["can", "can't", "swim", "cook", "drive"], vocabExamples: [["I can swim.", "Je sais nager."], ["I can't cook.", "Je ne sais pas cuisiner."], ["Can you drive?", "Sais-tu conduire ?"], ["She can speak English.", "Elle sait parler anglais."]], didYouNotice: "« can » ne prend jamais de -s, même à la 3e personne : « he can », jamais « he cans ». C'est un modal — ils ont tous cette règle (will, must, should...).", tables: [CONJUGATIONS.canModal], prompt: "Dis trois choses que tu sais faire et une chose que tu ne sais pas faire, avec « can ».", promptEn: "Say three things you can do and one thing you can't do, using « can »." },
  6: { grammar: "want + to + infinitif (I want to...)", vocab: "Envies, objectifs", vocabWords: ["want to", "learn", "travel", "visit"], vocabExamples: [["I want to learn English.", "Je veux apprendre l'anglais."], ["She wants to travel.", "Elle veut voyager."], ["Do you want to visit Paris?", "Veux-tu visiter Paris ?"]], tables: [CONJUGATIONS.wantPresent], prompt: "Dis trois choses que tu veux faire, avec « I want to... ».", promptEn: "Say three things you want to do, using « I want to... »." },
  7: { grammar: "do / does — questions et négations avec les verbes ordinaires", vocab: "Verbes du quotidien : like, work, live", vocabWords: ["like", "work", "live", "don't", "doesn't"], vocabExamples: [["I don't like coffee.", "Je n'aime pas le café."], ["Does he work here?", "Est-ce qu'il travaille ici ?"], ["We don't live in Paris.", "Nous n'habitons pas à Paris."]], didYouNotice: "« do/does » n'a aucun sens propre dans ces phrases — c'est juste un outil grammatical obligatoire pour les questions et négations avec les verbes ordinaires (pas avec to be, to have, ou les modaux).", tables: [CONJUGATIONS.doDoesQuestions], prompt: "Pose trois questions avec do/does à quelqu'un sur ses goûts ou son travail.", promptEn: "Ask someone three questions with do/does about their likes or their job." },
  8: { grammar: "there is / there are — dire qu'une chose existe (forme affirmative)", vocab: "Lieux, objets du quotidien", vocabWords: ["there is", "there are", "a supermarket", "two people"], vocabExamples: [["There is a supermarket near here.", "Il y a un supermarché près d'ici."], ["There are two people in the room.", "Il y a deux personnes dans la pièce."], ["There is some milk in the fridge.", "Il y a du lait dans le frigo."]], didYouNotice: "« there is/are » sert à dire qu'une chose existe quelque part — l'équivalent de « il y a » en français, mais ce n'est pas un verbe unique : « is/are » change selon le singulier ou le pluriel.", tables: [CONJUGATIONS.thereIsAre], prompt: "Décris ce qu'il y a dans ta maison ou dans ta ville, avec « there is / there are ».", promptEn: "Describe what's in your house or your town, using « there is / there are »." },
  9: { grammar: "there is / there are — négation et questions (Is there...? Are there...? There isn't/aren't)", vocab: "Révision : lieux, objets", vocabWords: ["Is there...?", "Are there...?", "there isn't", "there aren't"], vocabExamples: [["Is there a bus?", "Y a-t-il un bus ?"], ["There isn't any milk.", "Il n'y a pas de lait."], ["Are there any shops nearby?", "Y a-t-il des magasins à proximité ?"]], tables: [CONJUGATIONS.thereIsAre], prompt: "Pose trois questions avec « Is there...? » ou « Are there...? » sur ta ville ou ta maison.", promptEn: "Ask three questions with « Is there...? » or « Are there...? » about your town or your house." },
  10: { grammar: "Checkpoint : to be, to have/have got, can, want, do/does, there is/are", vocab: "Révision de tout le bloc 1", vocabWords: [], tables: [], prompt: "Enregistre un mini-monologue d'une minute mélangeant to be, to have, can, want, do/does et there is/are — sans regarder tes notes.", promptEn: "Record a one-minute mini-monologue mixing to be, to have, can, want, do/does, and there is/are — without looking at your notes." },
  11: { grammar: "to know — présent simple (I know, you know, he/she knows...)", vocab: "Savoir : know, a lot, nothing, the answer", vocabWords: ["know", "a lot", "nothing", "the answer"], vocabExamples: [["I know the answer.", "Je connais/sais la réponse."], ["She knows a lot about music.", "Elle en sait beaucoup sur la musique."], ["We don't know.", "Nous ne savons pas."], ["Do you know him?", "Le connais-tu ?"]], didYouNotice: "En français, « savoir » et « connaître » sont deux verbes différents. En anglais, « to know » couvre les deux sens : know the answer (savoir) et know him (connaître).", tables: [CONJUGATIONS.toKnowPresent], prompt: "Dis trois choses que tu sais et une chose que tu ne sais pas, avec « to know ».", promptEn: "Say three things you know and one thing you don't know, using « to know »." },
  12: { grammar: "to come — présent simple (I come, you come, he/she comes...)", vocab: "Venir : come, from, here, tomorrow", vocabWords: ["come", "from", "here", "tomorrow"], vocabExamples: [["I come from Nigeria.", "Je viens du Nigeria."], ["He comes here every day.", "Il vient ici tous les jours."], ["Are you coming tomorrow?", "Viens-tu demain ?"]], mistake: { wrong: "I am coming from Nigeria. (pour dire ton origine)", right: "I come from Nigeria.", note: "Pour l'origine (fixe, permanente), on utilise le présent simple « I come from », pas le present continuous — celui-ci sert seulement pour un déplacement en cours." }, tables: [CONJUGATIONS.toComePresent], prompt: "Dis d'où tu viens, et où quelqu'un de ta famille vient, avec « to come from ».", promptEn: "Say where you come from, and where someone in your family comes from, using « to come from »." },
  13: { grammar: "to see — présent simple (I see, you see, he/she sees...)", vocab: "Voir : see, often, sometimes, well", vocabWords: ["see", "often", "sometimes", "well"], vocabExamples: [["I see him often.", "Je le vois souvent."], ["She sees her family sometimes.", "Elle voit sa famille parfois."], ["I don't see well.", "Je ne vois pas bien."]], tables: [CONJUGATIONS.toSeePresent], prompt: "Dis qui tu vois souvent et qui tu vois rarement, avec « to see ».", promptEn: "Say who you see often and who you rarely see, using « to see »." },
  14: { grammar: "to take — présent simple (I take, you take, he/she takes...)", vocab: "Prendre : take, time, a shower, the bus", vocabWords: ["take", "time", "a shower", "the bus"], vocabExamples: [["I take the bus every morning.", "Je prends le bus tous les matins."], ["It takes time.", "Ça prend du temps."], ["He takes a shower at night.", "Il prend une douche le soir."]], didYouNotice: "« it takes time » est une expression figée très fréquente — littéralement « ça prend du temps », exactement comme en français.", tables: [CONJUGATIONS.toTakePresent], prompt: "Décris ta routine du matin en utilisant « to take » au moins deux fois.", promptEn: "Describe your morning routine, using « to take » at least twice." },
  15: { grammar: "Révision : know, come, see, take", vocab: "Révision libre", vocabWords: [], vocabExamples: [["I take my time when I see something new.", "Je prends mon temps quand je vois quelque chose de nouveau."], ["I know where he comes from.", "Je sais d'où il vient."]], tables: [CONJUGATIONS.toKnowPresent, CONJUGATIONS.toComePresent, CONJUGATIONS.toSeePresent, CONJUGATIONS.toTakePresent], prompt: "Mélange know, come, see et take dans quatre phrases sur toi et ta famille.", promptEn: "Mix know, come, see, and take into four sentences about you and your family." },
  16: { grammar: "to say / to put — présent simple", vocab: "Dire, mettre : say, put, always, the truth", vocabWords: ["say", "put", "always", "the truth"], vocabExamples: [["He always says the truth.", "Il dit toujours la vérité."], ["I put the keys on the table.", "Je mets les clés sur la table."], ["What did she say?", "Qu'a-t-elle dit ?"]], mistake: { wrong: "He says me that...", right: "He tells me that... / He says that...", note: "« say » ne prend jamais de personne directement après (say me — faux). Pour préciser à qui, on utilise « tell » : tell me, tell her." }, tables: [CONJUGATIONS.toSayPresent, CONJUGATIONS.toPutPresent], prompt: "Dis ce que tu dis souvent (I always say...) et où tu mets tes affaires (I put... on/in...).", promptEn: "Say what you often say (I always say...) and where you put your things (I put... on/in...)." },
  17: { grammar: "need to / have to — obligation", vocab: "Obligation : need to, have to, work, study", vocabWords: ["need to", "have to", "work", "study"], vocabExamples: [["I need to study.", "J'ai besoin d'étudier."], ["She has to work tomorrow.", "Elle doit travailler demain."], ["We don't need to hurry.", "Nous n'avons pas besoin de nous dépêcher."]], tables: [CONJUGATIONS.needHaveTo], prompt: "Dis trois choses que tu dois faire cette semaine, avec need to ou have to.", promptEn: "Say three things you need to do this week, using need to or have to." },
  18: { grammar: "Present continuous — formation (to be + verbe-ing)", vocab: "Actions en cours : right now, at the moment", vocabWords: ["right now", "at the moment", "-ing"], vocabExamples: [["I am learning English.", "J'apprends l'anglais (en ce moment)."], ["She is cooking right now.", "Elle est en train de cuisiner."], ["They are working at the moment.", "Ils travaillent en ce moment."]], didYouNotice: "Le present continuous est la vraie traduction de « être en train de » — une action qui se déroule maintenant, pas une habitude. C'est très différent du présent simple, qui décrit ce qui est toujours vrai.", mistake: { wrong: "I learn English right now.", right: "I am learning English right now.", note: "Avec « right now » ou « at the moment », il faut le present continuous, jamais le présent simple — c'est l'erreur la plus fréquente pour un francophone, car le présent simple français couvre les deux sens." }, tables: [CONJUGATIONS.presentContinuous], prompt: "Dis trois choses que tu es en train de faire en ce moment, avec le present continuous.", promptEn: "Say three things you're doing right now, using the present continuous." },
  19: { grammar: "Present continuous — usage & chunks conversationnels", vocab: "Révision : expressions de conversation courante (I think..., Maybe..., Really?)", vocabWords: [], vocabExamples: [["What are you doing?", "Qu'est-ce que tu fais (en ce moment) ?"], ["I think it's a good idea.", "Je pense que c'est une bonne idée."], ["Maybe you're right.", "Peut-être que tu as raison."]], didYouNotice: "Ces petites expressions (chunks) sont ce qui rend une conversation fluide — elles ne s'apprennent pas mot par mot, mais comme des blocs entiers, tout prêts à l'emploi.", tables: [CONJUGATIONS.presentContinuous], prompt: "Utilise le present continuous pour décrire ce que fait quelqu'un autour de toi, puis ajoute au moins deux chunks conversationnels.", promptEn: "Use the present continuous to describe what someone around you is doing, then add at least two conversational chunks." },
  20: { grammar: "Checkpoint : know, come, see, take, say, put, need to/have to, present continuous", vocab: "Révision de tout le bloc 2", vocabWords: [], tables: [], prompt: "Enregistre un mini-monologue d'une minute mélangeant know, come, see, take, say, put, need to/have to et le present continuous — sans regarder tes notes.", promptEn: "Record a one-minute mini-monologue mixing know, come, see, take, say, put, need to/have to, and the present continuous — without looking at your notes." },
  21: { grammar: "Past simple — verbes réguliers (+ -ed), forme affirmative", vocab: "Maison : house, apartment, room, kitchen, living room", vocabWords: ["house", "apartment", "room", "kitchen", "living room"], vocabExamples: [["I talked with my sister in the kitchen.", "J'ai parlé avec ma sœur dans la cuisine."], ["We worked in the living room.", "Nous avons travaillé dans le salon."], ["She cooked dinner yesterday.", "Elle a cuisiné le dîner hier."], ["They lived in that house.", "Ils ont habité dans cette maison."]], didYouNotice: "Contrairement au passé composé français (deux mots : avoir + participe), le past simple anglais tient en UN seul mot : talk → talked. Plus court, mais il ne change jamais selon la personne.", tables: [CONJUGATIONS.pastSimpleRegular], prompt: "Raconte ce que tu as fait hier avec des verbes réguliers en -ed : « I talked... », « I worked... ».", promptEn: "Tell what you did yesterday using regular -ed verbs: « I talked... », « I worked... »." },
  22: { grammar: "Past simple — verbes irréguliers fréquents (went, ate, saw, had, did, said)", vocab: "Vie quotidienne : work, phone, money, time", vocabWords: ["work", "phone", "money", "time"], vocabExamples: [["I went to work.", "Je suis allé(e) au travail."], ["She ate breakfast at home.", "Elle a mangé le petit-déjeuner à la maison."], ["We had a good time.", "Nous avons passé un bon moment."], ["He said nothing.", "Il n'a rien dit."]], mistake: { wrong: "I goed to work.", right: "I went to work.", note: "Les verbes irréguliers ne suivent pas la règle -ed — il faut les apprendre par cœur, un par un, exactement comme les participes passés irréguliers en français (été, fait, pris...)." }, tables: [], prompt: "Raconte ta journée d'hier avec au moins trois verbes irréguliers : went, ate, had, said, saw, did.", promptEn: "Tell about your day yesterday using at least three irregular verbs: went, ate, had, said, saw, did." },
  23: { grammar: "Révision : poser des questions au past simple (did)", vocab: "jour, semaine, week-end, matin, soir, nuit", vocabWords: ["day", "week", "weekend", "morning", "evening", "night"], vocabExamples: [["Did you sleep well?", "As-tu bien dormi ?"], ["What did you do this morning?", "Qu'as-tu fait ce matin ?"], ["Did she call you last night?", "T'a-t-elle appelé hier soir ?"]], didYouNotice: "Pour une question au passé, « did » porte tout le passé — le verbe qui suit reste à sa forme de base, jamais au passé deux fois (Did you went — faux).", tables: [CONJUGATIONS.pastSimpleDidQuestions], prompt: "Pose trois questions à quelqu'un sur sa semaine avec « did », puis réponds pour toi-même.", promptEn: "Ask someone three questions about their week using « did », then answer for yourself." },
  24: { grammar: "was / were — passé de « to be »", vocab: "repas, dîner, déjeuner, courses", vocabWords: ["meal", "dinner", "lunch", "groceries"], vocabExamples: [["I was tired yesterday.", "J'étais fatigué(e) hier."], ["The dinner was delicious.", "Le dîner était délicieux."], ["We were at the market this morning.", "Nous étions au marché ce matin."], ["Were you at home last night?", "Étais-tu à la maison hier soir ?"]], tables: [CONJUGATIONS.wasWere], prompt: "Décris où tu étais et comment tu te sentais hier, avec was/were.", promptEn: "Describe where you were and how you felt yesterday, using was/were." },
  25: { grammar: "Past simple — négation (didn't + verbe de base)", vocab: "ranger, nettoyer, rentrer", vocabWords: ["tidy up", "clean", "come home"], vocabExamples: [["I didn't clean the kitchen.", "Je n'ai pas nettoyé la cuisine."], ["She didn't come home early.", "Elle n'est pas rentrée tôt."], ["We didn't tidy up.", "Nous n'avons pas rangé."]], mistake: { wrong: "I didn't cleaned the kitchen.", right: "I didn't clean the kitchen.", note: "Comme pour les questions, « didn't » porte déjà le passé — le verbe reste à la forme de base, sans -ed après « didn't »." }, tables: [CONJUGATIONS.pastSimpleDidQuestions], prompt: "Dis trois choses que tu n'as pas faites hier, avec « didn't ».", promptEn: "Say three things you didn't do yesterday, using « didn't »." },
  26: { grammar: "Révision : was/were + négation au passé", vocab: "voyage, vacances, rendez-vous, projet", vocabWords: ["trip", "vacation", "appointment", "plan"], vocabExamples: [["We weren't ready for the trip.", "Nous n'étions pas prêts pour le voyage."], ["I didn't have an appointment.", "Je n'avais pas de rendez-vous."]], tables: [CONJUGATIONS.wasWere, CONJUGATIONS.pastSimpleDidQuestions], prompt: "Mélange was/were et didn't dans trois phrases sur un voyage ou un projet récent.", promptEn: "Mix was/were and didn't into three sentences about a recent trip or project." },
  27: { grammar: "Past simple — plus de verbes irréguliers (bought, thought, felt, left, wrote, told)", vocab: "problème, solution", vocabWords: ["problem", "solution"], vocabExamples: [["I bought some milk.", "J'ai acheté du lait."], ["She felt tired.", "Elle s'est sentie fatiguée."], ["He left early.", "Il est parti tôt."], ["I told her the solution.", "Je lui ai dit la solution."]], tables: [], prompt: "Utilise au moins trois de ces verbes irréguliers dans des phrases sur un problème récent : bought, thought, felt, left, wrote, told.", promptEn: "Use at least three of these irregular verbs in sentences about a recent problem: bought, thought, felt, left, wrote, told." },
  28: { grammar: "Marqueurs temporels et connecteurs de récit (yesterday, last week, then, after that, next)", vocab: "Révision vie quotidienne", vocabWords: ["yesterday", "last week", "then", "after that", "next"], vocabExamples: [["Yesterday, I woke up early.", "Hier, je me suis réveillé(e) tôt."], ["Then, I made breakfast.", "Puis, j'ai préparé le petit-déjeuner."], ["After that, I went to work.", "Après ça, je suis allé(e) au travail."]], didYouNotice: "Ces connecteurs sont ce qui transforme une liste de phrases en une vraie histoire — exactement comme « puis, ensuite, alors » en français.", tables: [], prompt: "Raconte ta matinée d'hier avec au moins trois connecteurs : yesterday, then, after that, next.", promptEn: "Tell about your morning yesterday using at least three connectors: yesterday, then, after that, next." },
  29: { grammar: "Mélange : past simple régulier + irrégulier + was/were", vocab: "Révision vie quotidienne", vocabWords: [], vocabExamples: [["Yesterday was a busy day. I woke up, had breakfast, and went to work.", "Hier était une journée chargée. Je me suis réveillé(e), j'ai pris le petit-déjeuner, et je suis allé(e) au travail."]], tables: [CONJUGATIONS.pastSimpleRegular, CONJUGATIONS.wasWere], prompt: "Raconte hier en mélangeant verbes réguliers, irréguliers et was/were dans au moins cinq phrases.", promptEn: "Tell about yesterday, mixing regular verbs, irregular verbs, and was/were into at least five sentences." },
  30: { grammar: "Révision libre du bloc", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Choisis cinq mots du bloc 3 que tu ne maîtrises pas encore et fais une phrase au past simple avec chacun.", promptEn: "Pick five words from block 3 you haven't mastered yet, and make a past simple sentence with each one." },
  31: { grammar: "Révision libre du bloc", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Relis les phrases des jours 21 à 29 à voix haute, deux fois chacune.", promptEn: "Read the sentences from Days 21 to 29 out loud, twice each." },
  32: { grammar: "Jour de parole : raconte ta journée d'hier en détail", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Parle de ce que tu as fait hier en détail, au moins six phrases, en utilisant des verbes réguliers et irréguliers au past simple.", promptEn: "Talk about what you did yesterday in detail, at least six sentences, using regular and irregular past simple verbs." },
  33: { grammar: "Jour de parole : raconte un événement familial récent", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Parle d'un événement familial récent, en utilisant was/were et au moins quatre verbes au past simple.", promptEn: "Talk about a recent family event, using was/were and at least four past simple verbs." },
  34: { grammar: "Révision des points faibles identifiés", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.pastSimpleDidQuestions, CONJUGATIONS.wasWere], prompt: "Reprends ce qui te bloque encore avec le past simple, et répète-le trois fois.", promptEn: "Go back over whatever still trips you up with the past simple, and repeat it three times." },
  35: { grammar: "Checkpoint du bloc : monologue de 2 minutes entièrement au past simple", vocab: "Révision de tout le bloc 3", vocabWords: [], tables: [], prompt: "Enregistre un monologue de deux minutes entièrement au past simple — parle de ta semaine.", promptEn: "Record a two-minute monologue entirely in the past simple — talk about your week." },
  36: { grammar: "going to — futur proche, forme affirmative", vocab: "manger, boire, café, eau", vocabWords: ["eat", "drink", "coffee", "water"], vocabExamples: [["I am going to eat.", "Je vais manger."], ["She is going to drink some water.", "Elle va boire de l'eau."], ["We are going to have coffee.", "Nous allons prendre un café."]], didYouNotice: "« going to » sert pour un plan déjà décidé — exactement comme « aller + infinitif » en français. Ce n'est pas un vrai futur simple, c'est une intention déjà là dans ta tête avant de parler.", tables: [CONJUGATIONS.goingTo], prompt: "Dis trois choses que tu vas faire aujourd'hui, avec « going to ».", promptEn: "Say three things you're going to do today, using « going to »." },
  37: { grammar: "going to — pratique : parler de cette semaine", vocab: "restaurant, invite, fête, anniversaire, cadeau", vocabWords: ["restaurant", "invite", "party", "birthday", "gift"], vocabExamples: [["We are going to have a party.", "Nous allons faire une fête."], ["I am going to invite my friends.", "Je vais inviter mes amis."], ["Are you going to buy a gift?", "Vas-tu acheter un cadeau ?"]], tables: [CONJUGATIONS.goingTo], prompt: "Dis trois choses que tu vas faire cette semaine, avec « going to ».", promptEn: "Say three things you're going to do this week, using « going to »." },
  38: { grammar: "Révision going to — questions et négation", vocab: "Révision nourriture & social", vocabWords: [], vocabExamples: [["I'm not going to work tomorrow.", "Je ne vais pas travailler demain."], ["What are you going to do this weekend?", "Qu'est-ce que tu vas faire ce week-end ?"]], tables: [CONJUGATIONS.goingTo], prompt: "Pose trois questions avec « going to » à quelqu'un sur son week-end.", promptEn: "Ask someone three questions with « going to » about their weekend." },
  39: { grammar: "Impératif — forme de base (Come here, Wait, Tell me, Do it)", vocab: "avoir un verre, cuisiner, recette, plat, dessert", vocabWords: ["have a drink", "cook", "recipe", "dish", "dessert"], vocabExamples: [["Come here!", "Viens ici !"], ["Wait a minute.", "Attends une minute."], ["Tell me the recipe.", "Dis-moi la recette."], ["Don't forget the dessert.", "N'oublie pas le dessert."]], didYouNotice: "L'impératif anglais ne change jamais, contrairement au français qui distingue « viens » (tu) de « venez » (vous) — en anglais, c'est toujours la même forme, quel que soit à qui tu parles.", tables: [CONJUGATIONS.imperativeForms], prompt: "Donne trois ordres ou demandes que tu ferais vraiment à la maison, avec l'impératif.", promptEn: "Give three orders or requests you'd actually make at home, using the imperative." },
  40: { grammar: "Impératif — forme « let's » (inclusif)", vocab: "santé, bon appétit, trinquer, partager un repas", vocabWords: ["cheers", "enjoy your meal", "toast", "share a meal"], vocabExamples: [["Let's eat!", "Mangeons !"], ["Let's go!", "Allons-y !"], ["Let's share this meal.", "Partageons ce repas."]], didYouNotice: "« Let's » = « let us », littéralement « laisse-nous » — c'est l'équivalent du « nous » de l'impératif français (allons-y, mangeons).", tables: [CONJUGATIONS.imperativeForms], prompt: "Propose trois activités à faire ensemble avec « Let's... ».", promptEn: "Suggest three activities to do together using « Let's... »." },
  41: { grammar: "Révision impératif (forme de base + let's)", vocab: "Révision nourriture & social", vocabWords: [], tables: [CONJUGATIONS.imperativeForms], prompt: "Mélange l'impératif direct et « let's » dans quatre phrases sur un repas partagé.", promptEn: "Mix the direct imperative and « let's » into four sentences about a shared meal." },
  42: { grammar: "just + past simple — action très récente, introduction", vocab: "Révision : appointment, plan", vocabWords: ["just", "already"], vocabExamples: [["I just finished my work.", "Je viens de finir mon travail."], ["She just called me.", "Elle vient de m'appeler."], ["We just arrived.", "Nous venons d'arriver."]], didYouNotice: "« just » + past simple est l'équivalent exact de « venir de » + infinitif en français — l'action vient tout juste de se terminer.", tables: [CONJUGATIONS.justPast], prompt: "Dis trois choses que tu viens juste de faire, avec « just ».", promptEn: "Say three things you just did, using « just »." },
  43: { grammar: "just + past simple — pratique", vocab: "Révision libre", vocabWords: [], vocabExamples: [["I just ate.", "Je viens de manger."], ["Did you just wake up?", "Viens-tu de te réveiller ?"]], tables: [CONJUGATIONS.justPast], prompt: "Utilise « just » dans une petite conversation imaginée — une personne demande, l'autre répond.", promptEn: "Use « just » in a short imagined conversation — one person asks, the other answers." },
  44: { grammar: "Révision : just + going to ensemble", vocab: "Révision libre", vocabWords: [], vocabExamples: [["I just finished dinner, so I'm going to relax.", "Je viens de finir le dîner, donc je vais me détendre."]], tables: [CONJUGATIONS.justPast, CONJUGATIONS.goingTo], prompt: "Fais trois phrases qui mélangent « just » (ce que tu viens de faire) et « going to » (ce que tu vas faire ensuite).", promptEn: "Make three sentences mixing « just » (what you just did) and « going to » (what you're about to do next)." },
  45: { grammar: "Mélange : projets + actions récentes + demandes", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.goingTo, CONJUGATIONS.imperativeForms, CONJUGATIONS.justPast], prompt: "Fais cinq phrases qui mélangent going to, l'impératif et just + past.", promptEn: "Make five sentences mixing going to, the imperative, and just + past." },
  46: { grammar: "Jour de parole : fais des projets pour le week-end à voix haute", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Dis tes projets pour le week-end à voix haute, au moins cinq phrases, en utilisant going to.", promptEn: "Say your plans for the weekend out loud, at least five sentences, using going to." },
  47: { grammar: "Jour de parole : 5 vraies demandes que tu dirais à la maison", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Donne cinq vraies demandes que tu ferais réellement à la maison, en utilisant l'impératif.", promptEn: "Give five real requests you'd actually make at home, using the imperative." },
  48: { grammar: "Révision des points faibles", vocab: "Révision libre", vocabWords: [], tables: [CONJUGATIONS.goingTo, CONJUGATIONS.imperativeForms], prompt: "Reprends ce qui te bloque encore entre going to, l'impératif et just + past, et répète-le trois fois.", promptEn: "Go back over whatever still trips you up between going to, the imperative, and just + past, and repeat it three times." },
  49: { grammar: "Intègre tout le bloc dans un dialogue court", vocab: "Révision libre", vocabWords: [], tables: [], prompt: "Écris et dis un court dialogue (5-6 lignes) mélangeant going to, l'impératif et just + past.", promptEn: "Write and say a short dialogue (5-6 lines) mixing going to, the imperative, and just + past." },
