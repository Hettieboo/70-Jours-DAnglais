...
const CONJUGATIONS = {
  ...
  // --- Bloc 3 : past simple ---
  pastSimpleRegular: { title: "past simple — verbes réguliers (+ -ed)", rows: [["I / you / he / she / it / we / they", "verbe + -ed (même forme pour tout le monde !)"]], note: "Contrairement au français, le past simple ne change JAMAIS selon la personne. talk → talked, pour « je », « tu », « il », tout le monde." },
  ...
  imperativeForms: { title: "impératif — forme de base et « let's »", rows: [["ordre / demande directe", "verbe seul, sans sujet : Come here. Wait. Tell me."], ["forme négative", "Don't + verbe : Don't worry."], ["« nous » inclusif", "Let's + verbe : Let's go. Let's eat."]], note: "L'impératif anglais est le plus simple des trois langues : toujours la base du verbe, sans terminaison — pas de distinction tu/vous comme en français." },
  justPast: { title: "just + past simple — action très récente", rows: [["I / you / he / she / it / we / they", "just + verbe au past simple : I just finished."]], note: "Équivalent de « venir de » + infinitif en français : I just ate = Je viens de manger." },

  // --- Bloc 5 : formules d'adoucissement ---
  politeFormulas: { title: "formules de politesse", rows: [["I would like / I'd like", "demande adoucie — équivalent de « je voudrais »"], ["Could you...?", "demande polie — équivalent de « tu pourrais »"], ["Would you mind...?", "très poli — littéralement « ça te dérangerait de... ? », suivi d'un verbe en -ing"], ["It would be...", "équivalent de « ça serait... »"]], note: "« would » est la clé de la politesse en anglais, tout comme le conditionnel en français." },
  ...
  usedTo: { title: "used to — habitude passée révolue", rows: [["I / you / he / she / it / we / they", "used to + verbe à l'infinitif : I used to live in Lagos."]], note: "Équivalent le plus proche de l'imparfait français pour une habitude : « used to » ne change jamais de forme, quel que soit le sujet." }
};
...
const DAY_DETAILS = {
  ...
  50: { grammar: "Checkpoint du bloc : going to, impératif, just + past — les trois outils d'une vraie conversation sur un projet", vocab: "Révision de tout le bloc 4", vocabWords: ["just", "going to", "let's", "can you...please?"], examples: { grammar: [["Je vais appeler ma sœur ce soir.", "I'm going to call my sister tonight."], ["Ne t'inquiète pas.", "Don't worry."], ["Je viens de me réveiller.", "I just woke up."], ["Est-ce que tu vas travailler demain ?", "Are you going to work tomorrow?"], ["Attends-moi !", "Wait for me!"]], listening: [["Je viens de finir.", "I just finished."], ["On va faire quoi ce week-end ?", "What are we going to do this weekend?"], ["Allons-y ensemble.", "Let's go together."], ["Peux-tu vérifier les horaires, s'il te plaît ?", "Can you check the times, please?"]] }, dialogue: [["Hettia", "Je viens de finir de nettoyer la cuisine.", "I just finished cleaning the kitchen."], ["Pierrot", "Génial ! On va faire quoi ce week-end ?", "Great! What are we going to do this weekend?"], ["Hettia", "Je vais rendre visite à ma sœur samedi. Tu veux venir ?", "I'm going to visit my sister on Saturday. Do you want to come?"], ["Pierrot", "Oui ! Allons-y ensemble.", "Yes! Let's go together."], ["Hettia", "Parfait. Peux-tu vérifier les horaires de train, s'il te plaît ?", "Perfect. Can you check the train times, please?"], ["Pierrot", "Bien sûr, donne-moi une minute.", "Sure, give me a minute."]], didYouNotice: "En anglais, tu peux enchaîner les trois formes du bloc dans une seule conversation naturelle sans les confondre : ce qui vient de se passer (just), ce qui va se passer (going to), et une demande immédiate (l'impératif). C'est exactement comme ça qu'un anglophone organise une conversation sur un projet — regarde le dialogue du jour.", didYouNoticeEn: "In English, you can chain all three forms in one natural conversation about a plan without mixing them up: what just happened (just), what's about to happen (going to), and an immediate request (the imperative). That's exactly how an English speaker structures a conversation about a plan — look at today's dialogue.", mistake: { wrong: "I'm going eat with you.", right: "I'm going to eat with you.", note: "Ne saute jamais le « to » après going, même à l'oral rapide — à l'oral familier il se réduit à « gonna » (I'm gonna eat), mais il ne disparaît jamais complètement.", noteEn: "Never drop the « to » after going, even in fast speech — in casual spoken English it shrinks to « gonna » (I'm gonna eat), but it never disappears completely." }, tables: [CONJUGATIONS.goingTo, CONJUGATIONS.imperativeForms, CONJUGATIONS.justPast], prompt: "Enregistre un mini-dialogue de deux minutes avec Pierrot (ou imagine les deux voix) qui mélange going to, l'impératif et just + past — inspire-toi du dialogue du jour, mais invente ta propre situation.", promptEn: "Record a two-minute mini-dialogue with Pierrot (or imagine both voices) mixing going to, the imperative, and just + past — take inspiration from today's dialogue, but invent your own situation." },
